...
/** Class for the Corner Cell which is a sub-class of Cell. Inherits all attributes and methods */
public class Corner extends Cell {

  private int cornerNum;

  /**
   * Constructor which sets the location and state of the Corner cell based on the inputs
   *
