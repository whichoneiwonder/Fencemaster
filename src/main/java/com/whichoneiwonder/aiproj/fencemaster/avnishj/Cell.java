...
/** Super class for cells, which has attributes and methods for a Center type cell */
public class Cell implements com.whichoneiwonder.aiproj.fencemaster.Piece {
  ...
  /**
   * Constructor which sets the location and state of the cell based on the inputs
   *
  ...
  /**
   * @param sets the newLink Cell to the edge number denoted by the index
   */
  ...
  /**
   * Creates the links of the cell with the indices being the respective edge number and the value
