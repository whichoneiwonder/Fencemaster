...
/** Class for the Edge Cell which is a sub-class of Cell. Inherits all attributes and methods */
public class Edge extends Cell {
  ...
  /**
   * Constructor which sets the location and state of the Edge cell based on the inputs
   *
